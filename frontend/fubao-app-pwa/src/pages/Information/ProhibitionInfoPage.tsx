...
const fishImages = [
  ...
  {
    name: "감성돔",
    image: "/imgs/fish/gamsungdom.png",
    link: "/detail/감성돔",
  }, // 8. 감성돔
  { name: "돌돔", image: "/imgs/fish/doldom.png", link: "/detail/돌돔" }, // 9. 돌돔
  {
    name: "쥐노래미",
    image: "/imgs/fish/gnoraemi.png",
    link: "/detail/쥐노래미",
  }, // 10. 쥐노래미
];
  ...
  return (
    <div style={{ position:"relative" }}>
      <ChevronLeftIcon
        ...
        onClick={handleBack}
      />
      <div style={{ padding: "1rem 0rem 0rem", textAlign:"center", fontSize:"1.3rem" }}>
        <span>금어기 안내</span>
      </div>
      <TableContainer
        component={Paper}
            ...
            {prohibitInfo.map((info) => (
              <TableRow key={info.id} style={{ borderBottom: "none" }}>
                ...
                <TableCell>
                  ...
                  <div>
                    금지 시작일:{" "}
                    {info.standard_start ? info.standard_start : "N/A"}
                  </div>
                  <div>
                    금지 종료일: {info.standard_end ? info.standard_end : "N/A"}
                  </div>
                </TableCell>
              </TableRow>
            ))}
