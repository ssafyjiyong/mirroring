...
// 사용할 아이콘을 라이브러리에 추가
library.add(faSeedling, faRightFromBracket, faRightToBracket, faArrowLeft, faArrowRight, faChevronLeft, faChevronRight, faCameraRetro, faBell, faHatCowboySide, faGear, emptystar, faStar, faArrowRotateLeft, faBan, faFish, faClipboardQuestion, faPlus, faUser, faBook, faCompass, faHome, faCalendarDay, faMap, faCheck);