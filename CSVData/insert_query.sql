#낚시 방법  import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\method.CSV' 
...
#낚시 구역 import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\area.CSV' 
...
#낚시 미끼 import
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\FishingBait.CSV' 
...
#방생기준 import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\releaseFish.CSV' 
...
#금어기  import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\prohibitFish.CSV' 
...
#어종 import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\Fish.CSV' 
...
#어종-area import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\fish_fish_area_id.CSV' 
...
#어종-bait import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\fish_fish_bait_id.CSV' 
...
#어종-method import 
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\fish_method.CSV' 
...
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\Users\\ \\S10P12C104\\CSVData\\location_method.CSV' 
